...
Devtools is a collection of 43 web-based developer tools deployed via GitHub Pages. It's a static site built with vanilla HTML, CSS, and JavaScript that provides utilities for text processing, data conversion, encoding/decoding, API testing, network analysis, and more.
...
- Encoding (base64, URL, HTML entities, hex conversion)
- Data Format (JSON formatting/diff/Patch, JSON string escaping, SQL formatting, XML formatting/conversion, YAML, CSV conversion/visualization)
- Web (URL parsing, CURL constructor, JWT decoder)
- Crypto (hash generation, HMAC signatures, UUID/ULID, passwords)
...
1. Update tool count in both README.md and AGENTS.md
2. Add new tools to the numbered list in README.md
3. Update tool categories in AGENTS.md if new categories are added
